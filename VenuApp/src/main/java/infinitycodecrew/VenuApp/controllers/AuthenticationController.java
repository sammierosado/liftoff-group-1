...
public class AuthenticationController {
    ...
    public String displayRegistrationForm(Model model) {
        model.addAttribute(new dto.RegisterFormDTO());
        model.addAttribute("title", "Register");
        return "users/register";
    }

    @PostMapping("/register")
    public String processRegistrationForm(@ModelAttribute @Valid dto.RegisterFormDTO registerFormDTO,
    ...
    public String displayLoginForm(Model model) {
        model.addAttribute(new dto.LoginFormDTO());
        model.addAttribute("title", "Log In");
        return "users/login";
    }

    @PostMapping("/login")
    public String processLoginForm(@ModelAttribute @Valid dto.LoginFormDTO loginFormDTO,
                                   Errors errors, HttpServletRequest request,
                                   Model model){
        if (errors.hasErrors()){
            model.addAttribute("title", "Log In");
