...
const VenuGoogleMap = () => {
  ...
  // geolocation on which the Google map is centered. feel free to change it!
  ...
  // disables default google map street view and satellite etc options. useMemo keeps it from recalculating these options a bunch
